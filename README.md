...
<p style="font-size:16px;">
  I'm an aspiring <strong>Frontend Developer</strong> from India with a passion for the crossover between <strong> design and programming</strong>. I have expertise in <strong>frontend technologies</strong> such as <strong>HTML5, CSS3, JavaScript, jQuery, React.js, Redux, 
